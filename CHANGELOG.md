...
- **Build/Export Workflow**: Export builds are now triggered by lightweight tag pushes
  ...
  - Godot version is automatically extracted from `project.godot` and used in artifact names
  - Build artifacts include Godot version (e.g., `web-build-v4.5`, `windows-build-v4.5`)
...
5. Artifacts will be named with the Godot version from `project.godot` (currently 4.5)
